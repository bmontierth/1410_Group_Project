...
//		adventurePane();
	...
	private void adventurePane() {
		...
		JLabel mHeroSprite = new JLabel("");
		mHeroSprite.setIcon(CLASS.fullImage);
		mHeroSprite.setBounds(344, 117, 128, 128);
		mainRoom.add(mHeroSprite);
		...
		JLabel uHeroSprite = new JLabel("");
		uHeroSprite.setIcon(CLASS.fullImage);
		uHeroSprite.setBounds(25, 400, 128, 128);
		upperRoom.add(uHeroSprite);
		...
		JLabel lHeroSprite = new JLabel("");
		lHeroSprite.setIcon(CLASS.fullImage);
		lHeroSprite.setBounds(160, 112, 128, 128);
		lowerRoom.add(lHeroSprite);
		...
		JLabel eHeroSprite = new JLabel("");
		eHeroSprite.setIcon(CLASS.fullImage);
		eHeroSprite.setBounds(25, 400, 128, 128);
		eastRoom.add(eHeroSprite);
	...
	private void startingPane() {
		...
		final JLabel lblChosenHero = new JLabel("");
